...
const WallpaperGroups = {
    ...
    p4m: {
        ...
        // D₄ Cayley table - elementos en orden: e, C₄, C₂, C₄³, σᵥ, σₕ, σ_d, σ_d′
        // Notación: σᵥ = reflexión eje vertical (x=0), σₕ = eje horizontal (y=0)
        // σ_d = diagonal principal (y=x), σ_d′ = antidiagonal (y=-x)
        // Convención: R × σ significa primero σ, luego R (lectura derecha a izquierda)
        cayleyTable: {
            ...
            table: [
                ...
                // C₄ × _
                ['C₄', 'C₂', 'C₄³', 'e', 'σ_d', 'σ_d′', 'σₕ', 'σᵥ'],
                // C₂ × _
                ['C₂', 'C₄³', 'e', 'C₄', 'σₕ', 'σᵥ', 'σ_d′', 'σ_d'],
                // C₄³ × _
                ['C₄³', 'e', 'C₄', 'C₂', 'σ_d′', 'σ_d', 'σᵥ', 'σₕ'],
                // σᵥ × _
                ['σᵥ', 'σ_d′', 'σₕ', 'σ_d', 'e', 'C₂', 'C₄³', 'C₄'],
                // σₕ × _
                ['σₕ', 'σ_d', 'σᵥ', 'σ_d′', 'C₂', 'e', 'C₄', 'C₄³'],
                // σ_d × _
                ['σ_d', 'σᵥ', 'σ_d′', 'σₕ', 'C₄', 'C₄³', 'e', 'C₂'],
                // σ_d′ × _
                ['σ_d′', 'σₕ', 'σ_d', 'σᵥ', 'C₄³', 'C₄', 'C₂', 'e']
            ]
        },
        explanation: `
